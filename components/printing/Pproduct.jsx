...
const Pproduct = ({data:{image , dname , descr}}) => {
  return (
<div className='px-2 border border-orange-400 m-2 flex flex-col space-y-2 rounded-md'> 
     <img src={urlFor(image)} alt='product image' layout='fill'  className='rounded-md object-cover w-full h-[80%]  md:h-56 overflow-hidden'/>
