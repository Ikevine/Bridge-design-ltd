...
const Experiance = ({experiance:{header,edescr}}) => {
  return (
        <div className="w-[95%] mx-auto p-6 text-white mb-8">
            ...
            <div className="flex gap-6 justify-center md:flex-row  flex-col">
                ...
                <div className="pt-10 description flex flex-col space-y-6 md:w-[40%]">
                    <h2 className='font-semibold md:text-3xl text-2xl text-center'>{header}</h2>
